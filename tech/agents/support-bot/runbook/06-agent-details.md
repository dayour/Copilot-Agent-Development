...
**Parameters**:
- url: `https://copilotstudio.preview.microsoft.com/environments/YOUR_ENVIRONMENT_ID_2/bots/YOUR_BOT_ID/manage/details`
...
1. Verify the bot ID in the URL matches the expected value: `YOUR_BOT_ID`
