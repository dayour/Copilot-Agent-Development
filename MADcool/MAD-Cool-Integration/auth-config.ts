...
export const msalConfig: Configuration = {
  auth: {
    ...
    clientId: process.env.VITE_AZURE_CLIENT_ID || 'YOUR_AZURE_CLIENT_ID',
    
    // Authority URL for Cypherdyne tenant (single tenant configuration)
    // This connects to your specific Copilot Studio environment
    authority: process.env.VITE_AZURE_AUTHORITY || 'https://login.microsoftonline.com/YOUR_AZURE_TENANT_ID',
