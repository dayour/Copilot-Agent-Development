...
VITE_AZURE_AUTHORITY=https://login.microsoftonline.com/YOUR_AZURE_TENANT_ID

# Copilot Studio Agent Configuration
# These connect to your MeetingAssist agent in the darbotlabs environment
VITE_COPILOT_ENVIRONMENT_ID=YOUR_ENVIRONMENT_ID
VITE_COPILOT_AGENT_SCHEMA=dystudio_meetMaster
VITE_COPILOT_AGENT_ID=YOUR_AGENT_ID

# Power Platform Configuration
# These connect to your Cypherdyne tenant and darbotlabs environment
VITE_POWER_PLATFORM_ENVIRONMENT_URL=https://YOUR_ORG.crm.dynamics.com/
